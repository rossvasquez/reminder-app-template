    ...
    return(
        <form onSubmit={(e) => handleLogin(e)} className='w-full max-w-3xl px-4 md:px-6 bg-zinc-800 rounded-sm shadow-lg'>
            ...
            <div className="flex flex-col justify-center items-center pb-4">
                ...
                <button type="submit" className="w-full mx-auto h-16 rounded-sm hover:bg-cyan-400 border-2 border-cyan-400 transition-all duration-[300ms] text-white text-2xl font-light hover:cursor-pointer mt-8 mb-6 hover:bg-opacity-[90%] active:text-neutral-300">Let's Go</button>
            </div>
        </form>
    )
}